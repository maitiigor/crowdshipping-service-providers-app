...
const FileUploader: React.FC<FileUploaderProps> = ({
  ...
  return (
    ...
    >
      ...
      <View
        className={twMerge(
          "items-center justify-center overflow-hidden border-none border-primary-500 bg-rose-50 shadow-md shadow-black/10 relative",
          disabled && "opacity-60"
        )}
      ...
      >
        ...
        >
          <View className="mt-auto bg-white rounded-t-3xl p-4">
            ...
            {(allowImages || allowVideos) && (
              <Pressable
                className="h-12 rounded-lg bg-rose-50 border border-background-300 items-center justify-center mb-3"
